        ...
        <div class="mt-12">
            <div class="card bg-white border-2 border-gray-400">
                ...
                <% if (typeof solution != "undefined") { %>
                    <div class="card-body bg-green-400 px-16 py-12">
                        ...
                        <% if (solution.getDocumentation().length !== 0) { %>
                            <div class="mt-6">
                                <span class="text-gray-800">READ MORE :</span>
                                <% for (let i in solution.getDocumentation()) { %> 
                                    <a href="<%= solution.getDocumentation()[i].link %>" class="text-gray-700 underline"><%= solution.getDocumentation()[i].text %></a>
                                <% } %>
                            </div>
                        <% } %>
                    </div>
            ...
            <div class="mt-10">
                <div class="tab flex flex-col bg-white border-2 border-gray-400" style="height: 100vh;max-height: 100vh;">
                        ...
                        <div class="w-full bg-indigo-500 flex flex-grow items-center px-8 py-2 justify-center">
                            <div class="menu">
                                <div class="menu-center flex flex-grow">
                                    ...
                                    <%- (typeof tab_header_render != "undefined") ? tab_header_render : "" %>
                    ...
                    <div class="tab-body bg-white h-full">
                        ...
                        <%- (typeof tab_content_render != "undefined") ? tab_content_render : "" %>
